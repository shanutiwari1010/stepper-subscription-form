...
export default function StepSidebar() {
  ...
  return (
    <aside className="flex md:block justify-center gap-4 md:gap-8 p-8 bg-[url('https://raw.githubusercontent.com/bradtraversy/react-step-form/main/src/assets/images/bg-sidebar-desktop.svg')] bg-no-repeat bg-cover rounded-lg text-white">
      {steps.map((step) => (
